              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ReusableText(text: items.title, style: appStyle(11, kDark,FontWeight.w400)),
                       ReusableText(text: "Delivery time: ${items.time}", style: appStyle(11, kGray,FontWeight.w400)),
                       SizedBox(
                        width: width * 0.7,
                        height: 15.h,
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Icon(MaterialCommunityIcons.cart_plus, color: kLightWhite, size: 15.h,),
                ),
            ),
          ),
          ),
